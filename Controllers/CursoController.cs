...
namespace WebEscuela.Controllers
{
    public class CursoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nombre,EscuelaId,Jornada,Direccion,Id")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Nombre,EscuelaId,Jornada,Direccion,Id")] Curso curso)
        {
            if (id != curso.Id)
            {
                return NotFound();
