...
namespace WebEscuela.Controllers
{
    public class EscuelaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Fundacion,AtributoTipoDeEscuela,Direccion,Id,Nombre")] Escuela escuela)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Fundacion,AtributoTipoDeEscuela,Direccion,Id,Nombre")] Escuela escuela)
        {
            if (id != escuela.Id)
            {
                return NotFound();
